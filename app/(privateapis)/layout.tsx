...
import { Image as LucideImage, Share, Camera, UserCircle, Settings } from 'lucide-react';
                            ...
                            <div className="w-10 rounded-full">
                                {imageUrl ? (
                                    <Image
                                        src={imageUrl}
                                        alt="User profile"
                                        width={40} // Set a width for optimization
                                        height={40} // Set a height for optimization
